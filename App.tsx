...
import { RotateCcw, Undo2, Trophy, Info, Bot, User, BrainCircuit } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  useEffect(() => {
    if (gameState.gameMode === GameMode.PVE && 
      ...
      // Use setTimeout to allow UI to render "Thinking..." state and ensure main thread isn't blocked immediately
